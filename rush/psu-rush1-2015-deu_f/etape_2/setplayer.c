/*
** setplayer.c for \ in /home/pidoux_q/epikong/etape_2
**
** Made by quentin pidoux
** Login   <pidoux_q@epitech.net>
**
** Started on  Sat Mar  3 14:04:47 2012 quentin pidoux
** Last update Sat Mar  3 14:04:48 2012 quentin pidoux
*/
...
void		aff_player(t_board* board, t_perso* pl, int x, int y)
{
  ...
  SDL_pos.x = pl->x * 30;
  SDL_pos.y = pl->y * 30;
  SDL_BlitSurface(pl->img[pl->way - Walk][pl->dir - LEFT], NULL, board->ecran, &SDL_pos);
  SDL_Flip(board->ecran);
}
