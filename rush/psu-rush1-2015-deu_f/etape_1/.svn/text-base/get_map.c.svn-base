/*
** get_map.c for  in /home/pidoux_q/epikong/etape_1
**
** Made by quentin pidoux
** Login   <pidoux_q@epitech.net>
**
** Started on  Sat Mar  3 13:57:43 2012 quentin pidoux
** Last update Sat Mar  3 13:57:44 2012 quentin pidoux
*/
...
void get_map(t_board *board, char  *filename)
{
  ...
  file_map = mmap(NULL,r_lseek, PROT_READ, MAP_SHARED, fd, 0);
  if (file_map == (void *)-1)
    {
      PRINT_ERROR;
      exit(EXIT_FAILURE);
