//
// koalanurse.cpp for ex_3 in /home/pidoux_q/cu/rendu/cpp/d07/ex_3
// 
// Made by quentin PIDOUX
// Login   <pidoux_q@epitech.net>
// 
// Started on  Mon Jan 10 18:49:27 2011 quentin PIDOUX
// Last update Mon Jan 10 21:50:43 2011 quentin PIDOUX
//
 ...
 if (files)
   {
     ...
     med.assign(str);
     delete[]str;
     std::cout <<"Nurse " << this->ID <<": Kreog ! Il faut donner un " << med << " a Mr." << patient << " !" << std::endl;
     files.close();
     return (med);
   }
 return (med);
...
void	 KoalaNurse::timeCheck()
{
  if (this->hospital == false)
    {
      std::cout <<"Nurse " << this->ID <<": Je commence le travail !" 
		<< std::endl;
      this->hospital = true;
    }
